 ...
 */
#define STRING_PRODUCT "YSoft IOTA Play bootloader"
#define STRING_MANUFACTURER "Y Soft Corporation, a.s."
#define USB_VID_HIGH   0x21
#define USB_VID_LOW    0x4C
#define USB_PID_HIGH   0x0A
